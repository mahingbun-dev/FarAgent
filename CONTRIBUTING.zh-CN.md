...
1. 先读 **[开发者文档](docs/zh/development.md)**（[Development](docs/development.md)）。
...
5. 用户能感知的行为请同步写进 [docs/user-guide.md](docs/user-guide.md) 和 [docs/zh/user-guide.md](docs/zh/user-guide.md)。
