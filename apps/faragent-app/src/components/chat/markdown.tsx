...
const CLASS = [
  ...
  "[&_code]:font-mono",
  "[&_h1]:mt-5 [&_h1]:mb-2 [&_h1]:font-display [&_h1]:text-lg",
  "[&_h2]:mt-5 [&_h2]:mb-2 [&_h2]:font-display [&_h2]:text-base",
...
const COMPONENTS: Components = {
  ...
  code: ({ className, children }) => {
    ...
    return (
      <pre className="my-2 overflow-x-auto rounded-md border border-border bg-code-bg px-3">
        <CodeBlock
          lines={text.replace(/\n$/, "").split("\n")}
